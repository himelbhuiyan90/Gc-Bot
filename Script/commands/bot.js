...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Himel") || (event.body.toLowerCase() == "হিমেল") || (event.body.toLowerCase() == "হিমেল") || (event.body.toLowerCase() == "ইনি হলেন চিত্রণ, আমার ক্রিয়েটর!💝")) {
  ...
  if ((event.body.toLowerCase() == "@ཧྱེ一ᏫᎰᎰᏞᏆᏁᎬ ꨄ মহা'রাজ一ཧྱེ ") || (event.body.toLowerCase() == "Himel")) {
   ...
   if ((event.body.toLowerCase() == "ami Chitron") || (event.body.toLowerCase() == "kire shipu")) {
